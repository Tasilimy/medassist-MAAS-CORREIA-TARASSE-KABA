...
```
========== TEST ÉVOLUTION A ==========
[✓] Test 1 : Table addresses existe
[✓] Test 2 : Toutes les colonnes requises existent
[✓] Test 3 : Contrainte CHECK sur address_type existe
[✓] Test 4 : Données migrées vers addresses (8 adresses)
[✓] Test 5 : Intégrité des adresses primaires
[✓] Test 6 : Vue patients_v1_view accessible
[✓] Test 7 : Index sur patient_id existe
========== RÉSUMÉ ==========
Tests passés: 7/7
```
