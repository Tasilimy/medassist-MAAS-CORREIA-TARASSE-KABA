...
-- Patients
INSERT INTO patients (id, first_name, last_name, birth_date, gender, ssn, phone, email,
address_line1, address_line2, city, postal_code) VALUES
(1, 'Marie', 'Dupont', '1985-03-15', 'F', '285037512345', '0601020304',
'marie.dupont@email.com', '12 Rue de la Paix', NULL, 'Paris', '75002'),
(2, 'Jean', 'Martin', '1972-08-22', 'M', '172086912345', '0611223344',
'jean.martin@email.com', '5 Avenue des Champs', 'Apt 3B', 'Lyon', '69001'),
(3, 'Sophie', 'Bernard', '1990-11-30', 'F', '290117512345', '0622334455',
'sophie.b@email.com', '28 Rue du Commerce', NULL, 'Marseille', '13001'),
(4, 'Pierre', 'Leroy', '1968-05-10', 'M', '168056912345', '0633445566',
'p.leroy@email.com', '3 Place de la République', NULL, 'Toulouse', '31000'),
(5, 'Isabelle', 'Moreau', '1995-01-25', 'F', '295017512345', '0644556677',
'isa.moreau@email.com', '15 Boulevard Victor Hugo', 'Bât C', 'Nantes', '44000'),
(6, 'François', 'Garcia', '1960-12-03', 'M', '160126912345', NULL,
NULL, '7 Impasse des Lilas', NULL, 'Bordeaux', '33000'),
(7, 'Camille', 'Roux', '2001-07-18', 'F', '201077512345', '0666778899',
'camille.roux@email.com', NULL, NULL, NULL, NULL),
(8, 'Antoine', 'Fournier', '1988-09-08', 'M', '188096912345', '0677889900',
...
INSERT INTO consultations (id, patient_id, doctor_name, consultation_date, symptoms,
diagnosis, notes, consultation_type, fee_amount, is_paid) VALUES
(1, 1, 'Dr Martin', '2024-01-15 09:00', 'Maux de tête fréquents',
'Migraines chroniques', 'Prescription antalgiques', 'GENERAL', 25.00, TRUE),
(2, 1, 'Dr. Martin', '2024-03-20 14:30', 'Suivi migraines',
'Amélioration', 'Continuer traitement', 'FOLLOW_UP', 25.00, TRUE),
(3, 2, 'Dr MARTIN', '2024-02-10 10:00', 'Douleur thoracique',
'Intercostal', 'RAS', 'EMERGENCY', 50.00, FALSE),
(4, 2, 'Dr Jean Martin', '2024-06-01 11:00', 'Contrôle annuel',
'Bonne santé', NULL, 'GENERAL', 25.00, TRUE),
(5, 3, 'Dr. Dubois', '2024-01-22 15:00', 'Allergie cutanée',
'Dermatite', 'Crème corticoïde', 'SPECIALIST', 50.00, TRUE),
(6, 3, 'Dr Dubois', '2024-04-10 09:30', 'Suivi dermatite',
'Résolution', NULL, 'FOLLOW_UP', 25.00, TRUE),
(7, 4, 'Dubois Claire', '2024-03-05 08:00', 'Entorse cheville',
'Entorse grade 2', 'Attelle + repos', 'EMERGENCY', 50.00, FALSE),
(8, 5, 'Dr. Jean MARTIN', '2024-05-15 16:00', 'Fatigue chronique',
'Carence fer', 'Bilan sanguin', 'GENERAL', 25.00, TRUE),
(9, 5, 'Dr Martin', '2024-07-20 10:00', 'Suivi carence',
'Normalisation', 'Arrêt supplémentation', 'FOLLOW_UP', 25.00, TRUE),
(10, 6, 'Dr Petit Anne', '2024-02-28 14:00', 'Douleurs articulaires',
'Arthrose débutante', 'Anti-inflammatoires', 'SPECIALIST', 50.00, TRUE),
(11, 7, 'Dr. Dubois', '2024-08-01 09:00', 'Vaccination',
NULL, 'Rappel DTP', 'GENERAL', 25.00, FALSE),
(12, 8, 'Martin Jean', '2024-04-22 11:30', 'Lombalgie',
'Lombalgie aiguë', 'Kiné prescrite', 'GENERAL', 25.00, TRUE),
(13, 1, 'Dr. Martin', '2023-06-15 09:00', 'Contrôle annuel',
'RAS', NULL, 'GENERAL', 25.00, TRUE),
(14, 2, 'Dr Martin', '2023-11-10 14:00', 'Grippe',
'Grippe saisonnière', 'Repos + paracétamol', 'GENERAL', 25.00, TRUE),
(15, 4, 'Dr Petit Anne', '2023-09-20 10:00', 'Bilan santé',
